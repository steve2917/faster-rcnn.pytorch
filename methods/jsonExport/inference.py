...
from model.utils.net_utils import export_detections
from model.utils.blob import im_list_to_blob
from model.faster_rcnn.resnet import resnet
import pdb

from methods.jsonExport.entities import Annotations
from methods.jsonExport.config import localConfig, parse_args
...
classes = localConfig.CLASSES.copy()
classes.insert(0, '__background__')

image_dir = localConfig.IMAGE_FOLDER
...
def inference_image(_index, _image, fasterRCNN):
    ...
    im_data, im_info, num_boxes, gt_boxes  = initilaization()
    ...
    im_file = os.path.join(image_dir, _image)
